...
public class CreateServiceTestData {
	...
	@Before
	public void createDefaultData() throws DataSetException, SQLException, DatabaseUnitException {
		...
		for (int i = 0; i < 10; i++) {
			...
			if (0 == i || 5 == i) {
				...
				for( int a = 0 ; a < 10 ; a++ ){
					Contact contact = new Contact("277845645" + String.valueOf(i) + String.valueOf(a), "MTN", organization.getName() + a, "contact lName" + (i+a));
		...
		dao.save(new NumberInfo("SA", "27", "^27[1-9][0-9]{8}$", channel));
	}

	private void createAdminOrgAndUser() {
