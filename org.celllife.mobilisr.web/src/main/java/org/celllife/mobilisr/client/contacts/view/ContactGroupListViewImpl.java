...
public class ContactGroupListViewImpl extends EntityListTemplateImpl implements ContactGroupListView {
	...
	public void createView(){
		...
		layoutListTemplate(Messages.INSTANCE.contactListHeader_for_group("Group"), buttons, true);
	}
