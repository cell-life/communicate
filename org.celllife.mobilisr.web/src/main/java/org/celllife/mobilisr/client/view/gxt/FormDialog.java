...
public abstract class FormDialog extends Window {
	...
	private MyGXTButton saveButton;
	...
	protected void buildDialog() {
		...
		saveButton = new MyGXTButton("saveButton", Messages.INSTANCE.done());
		cancelButton = new MyGXTButton("cancelButton",
	...
	public MyGXTButton getSaveButton() {
		return saveButton;
	}
