...
public class PutCommand extends AbstractRestCommand {
	...
	public PutCommand(String baseUrl, String relativeUrl, Object post){
		super(baseUrl, relativeUrl, null);
		this.post = post;
	}

	public PutCommand(String baseUrl, String relativeUrl, Object post, Object... urlParameters) {
		super(baseUrl, relativeUrl, urlParameters);
		this.post = post;
	}

	public ClientResponse executeInternal(WebResource resource) {
		ClientResponse response = resource.accept(MediaType.TEXT_XML).put(ClientResponse.class, post);
		return response;
	}
