 ...
 */
package org.celllife.reporting.util;
...
public class JaxbUtil {
	...
	public Object read(InputStream inputStream) throws ReportingException{
		...
		try{
			...
			throw new ReportingException("Error parsing file",e);
		} finally {
			if (reader != null){
				try {
					reader.close();
	...
	public void write(Object object, OutputStream out) throws ReportingException{
